...
<?php echo Form::open(array('url'=>'comentario','method'=>'POST','autocomplete'=>'off', 'onsubmit'=> 'return checkSubmit();')); ?>
      ...
      <div class="row"> 
        ...
        <div class="form-group col-md-7">
          ...
          <div class="input-group">
           ...
           <?php echo Form::text('responsable', null, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca el responsable . . .', 'autofocus'=>'on', 'maxlength'=>'100']); ?>
      ...
      <div class="row">
        <div class="form-group col-md-11">
          ...
          <div class="input-group">
            ...
            <?php echo Form::textarea('comentario', null, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca el Comentario . . .', 'autofocus'=>'on', 'rows'=>'5', 'maxlength'=>'1024']); ?>
      ...
      <div class="row">
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
          ...
          <input name="_token" value="<?php echo e(csrf_token()); ?>" type="hidden"></input>
              <a href="<?php echo e(url('comentarios/list', ['id' => $cliente->idcliente ])); ?>" class="btn btn-danger btn-lg col-md-offset-2"><i class="fa fa-times" aria-hidden="true"></i> Cancelar</a>
