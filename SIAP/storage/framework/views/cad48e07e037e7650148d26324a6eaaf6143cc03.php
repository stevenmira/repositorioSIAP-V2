...
<section class="content-header">
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo e(url('cliente/credito/garantias', ['id' => $prestamo->idprestamo])); ?>"> Garantías </a></li>
...
<h4 style="text-align: center;font-family:  'Trebuchet MS', Helvetica, sans-serif; color: #333333; padding: 40px 0px 25px 0px;"><b>EDITAR GARANTÍA</b></h4>
...
<?php echo Form::model($garantia, ['method'=>'PATCH','route'=>['garantia.update',$garantia->idgarantia]]); ?>
      ...
      <div class="row"> 
        ...
        <div class="form-group col-md-4">
          ...
          <div class="input-group">
            ...
            <?php echo Form::text('marca', $garantia->marca, ['class' => 'form-control', 'placeholder'=>'Introduzca la marca . . .', 'maxlength'=>'50']); ?>
        ...
        <div class="form-group col-md-4">
          ...
          <div class="input-group">
            ...
            <?php echo Form::text('serie', $garantia->serie, ['class' => 'form-control', 'placeholder'=>'Introduzca la serie . . .', 'maxlength'=>'50']); ?>
        ...
        <div class="form-group col-md-2">
          ...
          <div class="input-group">
            ...
            <?php echo Form::number('valor', $garantia->valor, ['class' => 'form-control', 'step'=>'0.01', 'placeholder'=>'Digite el valor estimado . . .']); ?>
      ...
      <div class="row"> 
        <div class="form-group col-md-6">
          ...
          <div class="input-group">
            ...
            <?php echo Form::textarea('descripcion', $garantia->descripcion, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Describa la garantia . . .', 'rows'=>'3']); ?>
        ...
        <div class="form-group col-md-6">
          ...
          <div class="input-group">
            ...
            <?php echo Form::textarea('otros', $garantia->otros, ['class' => 'form-control', 'placeholder'=>'Describa las especificaciones . . .', 'rows'=>'3']); ?>
      ...
      <div class="row">
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
          ...
          <input name="_token" value="<?php echo e(csrf_token()); ?>" type="hidden"></input>
              <a href="<?php echo e(url('cliente/credito/garantias', ['id' => $prestamo->idprestamo])); ?>" class="btn btn-danger btn-lg col-md-offset-2"><i class="fa fa-times" aria-hidden="true"></i> Cancelar</a>
