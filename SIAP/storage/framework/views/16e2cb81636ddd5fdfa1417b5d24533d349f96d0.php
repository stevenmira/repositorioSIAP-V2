...
<section class="content-header">
  <h1 style="color: #333333; font-family: 'Times New Roman', Times, serif;">
   Cliente: <b><?php echo e($cliente->nombre); ?></b></br>
...
<section class="content">
  ...
  <div class="alert  fade in" style="background:  #ccff90;">
    ...
    <h4><b><?php echo e(Session::get('create')); ?></b>.</h4>
  </div>
  <?php endif; ?>
                    ...
                    <thead>
                        <tr class="success">
                          <th colspan="12">
                              ...
                              <h3 style="text-align: center;"><b>Estados de Cuenta</b><a class="btn btn-success pull-right verde" data-title="Crear Nuevo Estado" href="<?php echo e(URL::action('ComprobanteController@nuevoestado',$cliente->idcuenta)); ?>"><i class="fa fa-fw -square -circle fa-plus-square"></i></a></h3>
