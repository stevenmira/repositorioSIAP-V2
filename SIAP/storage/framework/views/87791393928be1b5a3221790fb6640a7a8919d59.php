...
role="dialog" tabindex="-1" id="modal-cancelar-<?php echo e($estadoc->idcomprobante); ?>">
	<?php echo e(Form::Open(array('action'=>array('ComprobanteController@cancelar',$estadoc->idcomprobante)))); ?>
