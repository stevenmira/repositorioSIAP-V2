...
role="dialog" tabindex="-1" id="modal-delete-<?php echo e($ma->idcodeudor); ?>">
	<?php echo e(Form::Open(array('action'=>array('CodeudorController@destroy',$ma->idcodeudor),'method'=>'delete'))); ?>
