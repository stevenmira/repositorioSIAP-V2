...
role="dialog" tabindex="-1" id="modal-deleteD-<?php echo e($cuenta->idcuenta); ?>">
	<?php echo e(Form::Open(array('action'=>array('TipoCreditoController@destroy',$cuenta->idcuenta),'method'=>'delete'))); ?>
