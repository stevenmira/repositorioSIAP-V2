...
role="dialog" tabindex="-1" id="modalCredito-delete-<?php echo e($prestamo->idprestamo); ?>">
	<?php echo e(Form::Open(['action'=>'CuentaController@updateCredito'])); ?>
				...
				<table>
					<tr>
						...
						<td style="padding: 0px 100px 15px 10px;">
							<?php echo Form::text('numerocheque', $prestamo->numerocheque, ['class' => 'form-control', 'maxlength'=>'50']); ?>
					...
					<tr>
						...
						<td  style="padding: 0px 100px 15px 10px;">
							<?php echo Form::number('saldo', $cuenta->capitalanterior, ['class' => 'form-control', 'maxlength'=>'30', 'step'=>'0.01']); ?>
					...
					<tr>
						...
						<td  style="padding: 0px 100px 15px 10px;">
							<?php echo Form::number('cuotas', $cuenta->cuotaatrasada, ['class' => 'form-control', 'step'=>'1']); ?>
					...
					<tr>
						...
						<td  style="padding: 0px 100px 15px 10px;">
							<?php echo Form::number('mora', $cuenta->mora, ['class' => 'form-control', 'step'=>'0.01']); ?>
	...
	<input type="text" name="idprestamo" hidden="on" value="<?php echo e($prestamo->idprestamo); ?>">
