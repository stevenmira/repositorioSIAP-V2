...
<?php echo Form::open(array('url'=>'record/imprimir','method'=>'GET','autocomplete'=>'off')); ?>

            <?php echo e(Form::token()); ?>



<input type="number" name="idcuenta" id="idcuenta" hidden="true" value="<?php echo e($cuenta->idcuenta); ?>">
<input type="number" name="idrecibo" id="idrecibo" hidden="true" value="<?php echo e($reciboAct->idrecibo); ?>">
<div class="col-md-12"> 
	<div class="panel panel-success">
		<div class="panel-body">
			<div><b>Cliente:</b> <?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?></div>
			<br>
			<div><b>Negocio:</b> <?php echo e($negocio->nombre); ?></div>
            <div class="row">
            <div class="col-md-2">
            </div>
            </div>
			...
			<div class="row">
                ...
                <div class="form-group col-md-1">
                    <div class="input-group">
                        <?php echo Form::text('recibo', $reciboAct->numerico, ['class' => 'form-control' , 'required' => 'required', 'autofocus'=>'on']); ?>
			...
			<div class="row">
                ...
                <div class="form-group col-md-1">
                    <div class="input-group">
                        <?php echo Form::text('salmon', $salmon, ['class' => 'form-control' , 'required' => 'required', 'autofocus'=>'on']); ?>
			...
			<div class="row">
                ...
                <div class="form-group col-md-1">
                    <div class="input-group">
                        <?php echo Form::text('cuotasatrasadas', $cuotasatrasadas, ['class' => 'form-control' , 'required' => 'required', 'autofocus'=>'on']); ?>
    		...
    		<div class="row">
        		<div class="form-group  col-md-offset-3"  >
            		...
            		<a class=" btn btn-danger" type="reset"  href="<?php echo e(URL::action('CuentaController@show',$cuenta->idcuenta)); ?>">Cancelar</a>
        		</div>
    		</div>
    	</div>
  	</div>
