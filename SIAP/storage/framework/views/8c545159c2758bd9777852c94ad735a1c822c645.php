...
role="dialog" tabindex="-1" id="modal-delete-<?php echo e($es->idcomprobante); ?>">
	<?php echo e(Form::Open(array('action'=>array('ComprobanteController@destroy',$es->idcomprobante),'method'=>'delete'))); ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" style="color: #000; background: #ff8a80; text-align: center; font-family:'Trebuchet MS', Helvetica, sans-serif;">
				...
				<p style="text-align: center;">-- <?php echo e($fechacomprobante); ?> --</p>
				<p style="text-align: center;">-- <?php echo e($es->estado); ?> --</p>
				<p style="text-align: center;">-- <?php echo e($es->estadodos); ?> --</p>
				<br>
