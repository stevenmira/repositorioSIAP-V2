...
<section class="content-header">
  ...
  <div class="row">
    ...
    <p class="col-md-3 col-lg-3 col-sm-3"><b>Fecha de Inicio:</b>&nbsp;&nbsp;&nbsp; <?php echo e($desdeX); ?></p>
    <p class="col-md-2 col-lg-2 col-sm-2"><b>Fecha Fin:</b>&nbsp;&nbsp;&nbsp; <?php echo e($hastaX); ?></p>
    ...
    <?php echo $__env->make('reportes.estrategicos.controlCreditos.modalGrafico', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo e(Form::Open(['action'=>'ReportesController@controlCreditosPDF', 'target'=>'_blank'])); ?>

    <p class="col-md-1 col-lg-1 col-sm-1">
      <input type="text" hidden="on" name="idcartera" value="<?php echo e($idcartera); ?>">
      <input type="date" hidden="on" name="desde" value="<?php echo e($desde); ?>">
      <input type="date" hidden="on" name="hasta" value="<?php echo e($hasta); ?>">
        ...
        <table style="">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: left;"><?php echo e($con->dui); ?></td>
                ...
                <td style="text-align: center;"><?php echo e(number_format($con->interes,2)); ?>%</td>
                <td style="text-align: right;"><span class="pull-left">&nbsp;$</span><?php echo e(number_format($con->comision,2)); ?></td>
                <td style="text-align: right;"><span class="pull-left">&nbsp;$</span><?php echo e(number_format($con->montooriginal,2)); ?></td>
                <td style="text-align: left;"><?php echo e($con->nombreCartera); ?></td>
                <td style="text-align: left;"><?php echo e($con->nombreEjecutivo); ?></td>
                <?php if($con->nombreDesembolso == 'EFECTIVO'): ?>
                <td style="text-align: left;"><?php echo e($con->nombreDesembolso); ?></td>
                <?php else: ?>
                <td style="text-align: left;"><?php echo e($con->numerocheque); ?></td>
                <?php endif; ?>
              </tr>
              <?php endforeach; ?>
            </tbody>
