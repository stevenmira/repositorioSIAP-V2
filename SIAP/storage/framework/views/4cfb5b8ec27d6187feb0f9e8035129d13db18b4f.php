<?php echo Form::open(array('url'=>'supervisor','method'=>'GET','autocomplete'=>'off','role'=>'search')); ?>
	...
	<div class="col-md-5 col-sm-5 col-xs-5 col-md-offset-0">
		<div class="form-group">
			...
			<select name="searchText"  class="form-control selectpicker" id="searchText" data-Live-search="true" title="-- Introduzca el criterio de búsqueda --">
				...
				<option value="<?php echo e($supervisor->apellido); ?>"><?php echo e($supervisor->nombre); ?> <?php echo e($supervisor->apellido); ?></option>
				<?php endforeach; ?>
			</select>
		</div>
	</div>
