...
<div class="row">
  <a href="<?php echo e(URL::action('CuentaController@desembolsoPDF',$cuenta->idcuenta)); ?>" target="_blank" class="btn btn-danger btn-lg pull-left" ><i class="fa fa-print" aria-hidden="true"></i> IMPRIMIR CON MORA</a>
</div>

<button type="submit" target="_blank" class="btn btn-danger btn-lg pull-right">
