	    ...
	    <tbody>
	      <tr>
	        ...
	        <td style="border: 1px solid #333; text-align: right;">
	        	...
	        	<span style="display: block; float: right"><?php echo e(number_format($prestamo->monto, 2)); ?></span> 
	        </td>
	  ...
	  <table style="width: 100%; border-collapse: collapse;">
	  	<tr>
			...
			<td style="font-weight: bold;">
				$ 
				<span class="spn"><?php echo e(number_format($prestamo->monto, 2)); ?></span>
			</td>
		</tr>
		<tr>
			...
			<td>
				$ 
				<span class="spn"><?php echo e(number_format($costo, 2)); ?></span>
			</td>
		</tr>
		<tr>
	      	<td></td>
	    ...
	    <tr>
	      ...
	      <td>
				$ 	
				<span class="spn"><?php echo e(number_format($montoreal, 2)); ?></span>	
			</td>
	    </tr>
	  </table>
	</div>
