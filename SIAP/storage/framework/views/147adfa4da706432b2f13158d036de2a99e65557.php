                   ...
                   <?php foreach($negocios as $ma): ?>
                      <tr>
                          ...
                          <td style="width: 150px;">
                              ...
                              <a class="btn btn-danger rojo" data-title="Inactivar Negocio" href="" data-target="#modal-delete-<?php echo e($ma->idnegocio); ?>" data-toggle="modal"><i class="fa fa-trash" aria-hidden="true"></i></a>
                              <?php else: ?>
                              <a class="btn btn-primary azul" data-title="Activar Negocio" href="" data-target="#modal-delete-<?php echo e($ma->idnegocio); ?>" data-toggle="modal"><i class="fa fa-check" aria-hidden="true"></i></a>
                              <?php endif; ?>
                          </td>
                      </tr>
