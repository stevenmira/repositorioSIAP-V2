...
<body>
	...
	<div align=center>ASESORES FINANCIEROS MICRO IMPULSADORES DE NEGOCIOS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($fecha); ?></div>
	...
	<table style="border-collapse: collapse;">
		<thead>
			<tr>
				...
				<th style="border: 1px solid #333;" rowspan="3" align="center"><span><?php echo e($tasa_interes*100); ?>%</th>
				<th rowspan="2"></th>
				<th rowspan="2"></th>
			</tr>
			<tr>
				<td style="border: 1px solid #333; height: 10px;" align="center"><span><?php echo e($tasa_interes*100); ?>%</td>
			</tr>
			<tr>
				<td style="border: 1px solid #333"></td>
				<td style="border: 1px solid #333" align=""><span>&nbsp;$ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($monto_capital); ?></span></td>
				<td style="border: 1px solid #333"></td>
				<td style="border: 1px solid #333"></td>
				<td></td>
				<td></td>
		...
		<tbody>
			...
			?>
			<tr>
				<td style="border: 1px solid #333" align="right"><span><?php echo e($n); ?></span></td>
				<td style="border: 1px solid #333" align="right"><span><?php echo e($liquidacion->fechadiaria->format('l j F Y')); ?></span></td>
				<td style="border: 1px solid #333"><span>&nbsp;$ <?php echo e(round($monto_capital,2)); ?></span></td>
				<td style="border: 1px solid #333"><span>&nbsp;$ <?php echo e(round($interes_diario,2)); ?></span></td>
				<td style="border: 1px solid #333"><span>&nbsp;$ <?php echo e(round($cuota_capital,2)); ?></span></td>
				<td style="border: 1px solid #333"><span>&nbsp;$ <?php echo e($pagos_diarios); ?></span></td>
			...
			?>
					<tr>
						<td style="border: 1px solid #333" align="right"><span><?php echo e($n); ?></span></td>
						<td style="border: 1px solid #333" align="right"><span><?php echo e($liquidacion->fechadiaria->format('l j F Y')); ?></span></td>
						<td style="border: 1px solid #333; text-align: right;"><span>&nbsp;$ <?php echo e(round($monto_capital,2)); ?></span></td>
						<td style="border: 1px solid #333; text-align: right;"><span>&nbsp;$ <?php echo e(round($interes_diario,2)); ?></span></td>
						<td style="border: 1px solid #333; text-align: right;"><span>&nbsp;$ <?php echo e(round($cuota_capital,2)); ?></span></td>
						<td style="border: 1px solid #333; text-align: right;"><span>&nbsp;$ <?php echo e($pagos_diarios); ?></span></td>
						<td style="border: 1px solid #333" align="center"><span></span></td>
						<td style="border: 1px solid #333" align="center"><span></span></td>
						<td style="border: 1px solid #333" align="center"><span></span></td>
					</tr>
			...
			<tr>
				...
				<td style="border: 1px solid #333"><span>&nbsp;$ <?php echo e(round($interes_diario,2)); ?></span></td>
				<td style="border: 1px solid #333"><span>&nbsp;$ <?php echo e(round($cuota_capital,2)); ?></span></td>
				<td style="border: 1px solid #333"><span>&nbsp;$ <?php echo e(round($total_diario,2)); ?></span></td>
				<td style="border: 1px solid #333" align="center"><span></span></td>
				<td style="border: 1px solid #333" align="center"><span></span></td>
				<td style="border: 1px solid #333" align="center"><span></span></td>
			</tr>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><span>&nbsp;$ <?php echo e(round($actasa,2)); ?></span></td>
				<td><span>&nbsp;$ <?php echo e(round($accuo,2)); ?></span></td>
				<td><span>&nbsp;$ <?php echo e(round($acdiar,2)); ?></span></td>
				<td></td>
				<td></td>
				<td></td>
			</tr>
