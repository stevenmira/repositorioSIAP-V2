	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background: #007E33; color: #fff;">
                ...
                <h4 class="modal-title">GRÁFICO -- ESTADO DE CRÉDITOS</h4>
			</div>
			<div class="modal-body" style="color: #000; background: #fff; font-family:'Trebuchet MS', Helvetica, sans-serif;">
					...
					new Chart(document.getElementById("pie-chart"), 
					{
					    ...
					    data: {
					      ...
					      datasets: [{
					        ...
					        data: [<?php echo e($p1); ?>,<?php echo e($p2); ?>]
					      }]
					    },
					    options: {
					      title: {
				...
				<table style="border: 0px solid #fff;">
					<tr style="border: 0px solid #fff; border-color:#e8c3b9; border-style:dashed; border-width:2px;">
						...
						<td style="border: 0px solid #fff; width: 10%;"><?php echo e($c1); ?></td>
						<td style="border: 0px solid #fff; width: 20%;">Desembolso:</td>
						<td style="border: 0px solid #fff; width: 20%; text-align: right; padding: 0px 15px;"><span class="pull-left">$</span> <?php echo e(number_format($sumMontoCompleto,2)); ?></td>
					</tr>
					<tr style="border: 0px solid #fff; border-color:#c45850; border-style:dashed; border-width:2px;">
						...
						<td style="border: 0px solid #fff; width: 10%;"><?php echo e($c2); ?></td>
						<td style="border: 0px solid #fff; width: 20%;">Desembolso:</td>
						<td style="border: 0px solid #fff; width: 20%; text-align: right; padding: 0px 15px;"><span class="pull-left">$</span> <?php echo e(number_format($sumMontoRefinanciamiento,2)); ?></td>
					</tr>
					<tr style="border: 0px solid #fff; border-color:#fff; border-style:dashed; border-width:2px; font-weight: bold;">
						...
						<td style="border: 0px solid #fff; width: 20%; text-align: right; padding: 0px 15px;"><span class="pull-left">$</span> <?php echo e(number_format($total,2)); ?></td>
					</tr>
				</table>
