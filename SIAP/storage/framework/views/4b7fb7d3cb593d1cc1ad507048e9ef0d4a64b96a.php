...
<h4 style="text-align: center;font-family:  'Trebuchet MS', Helvetica, sans-serif; color: #333333; padding: 40px 0px 25px 0px;"><b>EDITAR SUPERVISOR</b></h4>

<?php echo Form::model($supervisor,['method'=>'PATCH','route'=>['supervisor.update',$supervisor->idsupervisor], 'files'=>'true']); ?>
          ...
          <div class="row"> 
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::text('nombre', $supervisor->nombre, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca el nombre . . .', 'autofocus'=>'on', 'maxlength'=>'30']); ?>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::text('apellido', $supervisor->apellido, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Introduzca el apellido . . .', 'autofocus'=>'on', 'maxlength'=>'30']); ?>
          ...
          <div class="row"> 
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::text('dui', $supervisor->dui, ['class' => 'form-control', 'data-inputmask'=>'"mask": "99999999-9"',  'data-mask'=>'on']); ?>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::date('fechanacimiento', $supervisor->fechanacimiento, ['class' => 'form-control']); ?>
          ...
          <div class="row">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::textarea('direccion', $supervisor->direccion, ['class' => 'form-control', 'placeholder'=>'Introduzca la direccion . . .', 'rows'=>'1', 'maxlength'=>'255']); ?>
          ...
          <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::text('telefono', $supervisor->telefono, ['class' => 'form-control', 'data-inputmask'=>'"mask": "9999-9999"',  'data-mask'=>'on']); ?>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::email('correo', $supervisor->correo, ['class' => 'form-control']); ?>
          ...
          <div class="row"> 
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="input-group">
                ...
                <?php echo Form::textarea('comentario', $supervisor->comentario, ['class' => 'form-control', 'rows'=>'4']); ?>
...
<div class="row">
  <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
    ...
    <input name="_token" value="<?php echo e(csrf_token()); ?>" type="hidden"></input>
        <a href="<?php echo e(URL::action('SupervisorController@index')); ?>" class="btn btn-danger btn-lg col-md-offset-2"> Cancelar</a>
