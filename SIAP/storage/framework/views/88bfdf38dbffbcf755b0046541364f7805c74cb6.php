...
<?php echo Form::model($negocio, ['method'=>'PATCH','route'=>['negocio.update',$negocio->idnegocio]]); ?>
      ...
      <div class="row"> 
        ...
        <div class="form-group col-md-4">
          ...
          <div class="input-group">
            ...
            <?php echo Form::textarea('nombreNegocio', $negocio->nombre, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Digite el nombre del negocio . . .', 'autofocus'=>'on', 'rows'=>'3']); ?>
        ...
        <div class="form-group col-md-4">
          ...
          <div class="input-group">
            ...
            <?php echo Form::textarea('actividadEconomica', $negocio->actividadeconomica, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Digite la actividad economica del negocio . . . ', 'autofocus'=>'on', 'rows'=>'3']); ?>
        ...
        <div class="form-group col-md-4">
          ...
          <div class="input-group">
            ...
            <?php echo Form::textarea('direccionNegocio', $negocio->direccionnegocio, ['class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Digite la dirección del negocio . . .', 'autofocus'=>'on', 'rows'=>'3']); ?>
      ...
      <div class="row">
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
          ...
          <input name="_token" value="<?php echo e(csrf_token()); ?>" type="hidden"></input>
              <a href="<?php echo e(url('negocios/list', ['id' => $cliente->idcliente ])); ?>" class="btn btn-danger btn-lg col-md-offset-2">Cancelar</a>
