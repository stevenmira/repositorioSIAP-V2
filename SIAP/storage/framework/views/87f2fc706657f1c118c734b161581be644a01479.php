...
<?php echo Form::open(array('url'=>'calcular-credito/imprimir','method'=>'GET','autocomplete'=>'off')); ?>

            <?php echo e(Form::token()); ?>



<input type="number" name="monto_capital" id="monto_capital" hidden="true" value="<?php echo e($nuevo_monto); ?>">
<input type="number" name="gastos_diarios" id="gastos_diarios" hidden="true" value="<?php echo e($cuota); ?>">
<input type="number" name="tasa_interes" id="tasa_interes" hidden="true" value="<?php echo e($tasaInteres); ?>">
<input type="date" name="fecha" id="fecha" hidden="true" value="<?php echo e($fecha); ?>">
...
<div class="table-responsive">
  <table class="table table-striped table-bordered  table-condensed table-hover">
      ...
      <tr class="info">
        ...
        <td style="border: 1px solid #333; text-align: right;"><span align="center" >$ <?php echo e($nuevo_monto); ?> </span></td>
       <td style="border: 1px solid #333; text-align: right;"><span align="center" > <?php echo e($tasa); ?> % </span></td>
  ...
  <?php 
   ...
   ?>
      ...
      <tr>
        <td style="border: 1px solid #333;" align="right"><span> <?php echo e($contador); ?></span></td>

        <!-- Pasamos la fecha a español con Jenssegers -->
        
      
        <td style="border: 1px solid #333;" align="center"><span> <?php echo e($liquidacion->fechadiaria->format('l j  F Y ')); ?></span></td>
        

        <td style="border: 1px solid #333; text-align: right;"><span class="pull-left">&nbsp;$</span> <?php echo e($monto_capital); ?></td>

        <td style="border: 1px solid #333; text-align: right;"><span class="pull-left">&nbsp;$</span> <?php echo e($interes); ?></td>


       <?php if($monto_capital < $cuota): ?>
        <?php
        ...
        ?>
         <td style="border: 1px solid #333; text-align: right;"><span class="pull-left">&nbsp;$</span> <?php echo e($cuotacapital); ?></td>

        <td style="border: 1px solid #333; text-align: right;"><span class="pull-left">&nbsp;$</span> <?php echo e($cuota); ?></td>
       <?php else: ?>
         <td style="border: 1px solid #333; text-align: right;"><span class="pull-left">&nbsp;$</span> <?php echo e($cuotacapital); ?></td>
