...
<section class="content-header">
  ...
  <?php echo e(Form::Open(['action'=>'ReportesController@graficoReview'])); ?>
  ...
  <div class="row">
    ...
    <?php echo $__env->make('reportes.tacticos.grafico.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>
  <br><br>
  <?php echo Form::close(); ?>
