...
<?php echo Form::open(array('url'=>'empleado','method'=>'POST','autocomplete'=>'off', 'files'=>'true')); ?>
          ...
          <div class="row"> 
            ...
            <div class="form-group col-md-4">
              ...
              <div class="input-group">
                ...
                <?php echo Form::text('cargo', null, ['class' => 'form-control', 'placeholder'=>'Introduzca el cargo . . .', 'autofocus'=>'on', 'maxlength'=>'50']); ?>
...
<div class="row">
  <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
    ...
    <input name="_token" value="<?php echo e(csrf_token()); ?>" type="hidden"></input>
        <a href="<?php echo e(URL::action('EmpleadoController@index')); ?>" class="btn btn-danger btn-lg col-md-offset-2"><i class="fa fa-times" aria-hidden="true"></i>   Cancelar</a>
