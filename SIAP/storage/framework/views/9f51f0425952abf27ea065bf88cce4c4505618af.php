          ...
          <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12  col-md-12 col-lg-12 "> 
                      <table class="table table-user-information">
                        <tbody>
                          <tr>
                            <td>CUOTAS ATRASADAS <b class="col-xs-3 col-sm-3  col-md-3 col-lg-3"><?php echo Form::text('cuotasatrasadas',$estadoc->diasatrasados, ['id'=>'cuotasatrasadas','onkeyup'=>'Multi();Sumar()','class' => 'form-control' , 'required' => 'required','autofocus'=>'on','maxlength'=>'3']); ?></b> DE $<span id="cuota"><?php echo e($cliente->cuotadiaria); ?></span></td>
                            <td><b><?php echo Form::number('totalcuotas',$estadoc->totalcuotas, [ 'id'=>'totalcuotas','class' => 'form-control','readonly'=>'readonly', 'autofocus'=>'on','maxlength'=>'6']); ?></b></td>
                          </tr>
                          <tr>
                            <td>MONTO SIN INTERES:</td>
                            <td><?php echo Form::number('monto', $estadoc->montoactual, ['id'=>'monto','class' => 'form-control' ,'onkeyup'=>'Sumar()', 'required' => 'required', 'autofocus'=>'on', 'maxlength'=>'6']); ?></td>
                       
                          </tr>
                          <tr>
                            <td>Gastos Administrativos por Gestión de Cobros:</td>
                            <td><?php echo Form::number('gastosadmon', $estadoc->gastosadmon, ['id'=>'gastosadmon','onkeyup'=>'Sumar()','class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Gastos por Cobros. . .', 'autofocus'=>'on', 'maxlength'=>'6']); ?></td>
                          </tr>
                          <tr>
                            <td>Gastos Administrativos por Notificación:</td>
                            <td><?php echo Form::number('gastosnoti', $estadoc->gastosnotariales, ['id'=>'gastosnoti','onkeyup'=>'Sumar()','class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Gastos por Notificación. . .', 'autofocus'=>'on', 'maxlength'=>'6']); ?></td>
                          </tr>
                          <tr>
                            <td><b style="color:red">TOTAL A CANCELAR</b></td>
                            <td><b><?php echo Form::number('total', $estadoc->total, [ 'id'=>'total','class' => 'form-control' ,'readonly'=>'readonly', 'autofocus'=>'on', 'maxlength'=>'6']); ?></b></td>
              ...
              <input name="_token" value="<?php echo e(csrf_token()); ?>" type="hidden"></input>
                  ...
                  <button class="btn btn-primary btn-lg col-md-offset-2" type="submit">Editar</button>
              </div>
            </div>
          </div>
