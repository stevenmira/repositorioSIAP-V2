...
role="dialog" tabindex="-1" id="modalEstado-delete-{{$es->idcomprobante}}">
	{{Form::Open(['action'=>'ComprobanteController@updateEstado'])}}
	...
	<input type="text" name="idcomprobante" hidden="on" value="{{$es->idcomprobante}}">
	{{Form::Close()}}
</div>