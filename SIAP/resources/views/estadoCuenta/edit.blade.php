                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12  col-md-12 col-lg-12 "> 
                      <table class="table table-user-information">
                        <tbody>
                          <tr>
                            <td>CUOTAS ATRASADAS <b class="col-xs-3 col-sm-3  col-md-3 col-lg-3">{!! Form::text('cuotasatrasadas',$estadoc->diasatrasados, ['id'=>'cuotasatrasadas','onkeyup'=>'Multi();Sumar()','class' => 'form-control' , 'required' => 'required','autofocus'=>'on','maxlength'=>'3']) !!}</b> DE $<span id="cuota">{{$cliente->cuotadiaria}}</span></td>
                            <td><b>{!! Form::number('totalcuotas',$estadoc->totalcuotas, [ 'id'=>'totalcuotas','class' => 'form-control','readonly'=>'readonly', 'autofocus'=>'on','maxlength'=>'6']) !!}</b></td>
                          </tr>
                          <tr>
                            <td>MONTO SIN INTERES:</td>
                            <td>{!! Form::number('monto', $estadoc->montoactual, ['id'=>'monto','class' => 'form-control' ,'onkeyup'=>'Sumar()', 'required' => 'required', 'autofocus'=>'on', 'maxlength'=>'6']) !!}</td>
                       
                          </tr>
                          <tr>
                            <td>Gastos Administrativos por Gestión de Cobros:</td>
                            <td>{!! Form::number('gastosadmon', $estadoc->gastosadmon, ['id'=>'gastosadmon','onkeyup'=>'Sumar()','class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Gastos por Cobros. . .', 'autofocus'=>'on', 'maxlength'=>'6']) !!}</td>
                          </tr>
                          <tr>
                            <td>Gastos Administrativos por Notificación:</td>
                            <td>{!! Form::number('gastosnoti', $estadoc->gastosnotariales, ['id'=>'gastosnoti','onkeyup'=>'Sumar()','class' => 'form-control' , 'required' => 'required', 'placeholder'=>'Gastos por Notificación. . .', 'autofocus'=>'on', 'maxlength'=>'6']) !!}</td>
                          </tr>
                          <tr>
                            <td><b style="color:red">TOTAL A CANCELAR</b></td>
                            <td><b>{!! Form::number('total', $estadoc->total, [ 'id'=>'total','class' => 'form-control' ,'readonly'=>'readonly', 'autofocus'=>'on', 'maxlength'=>'6']) !!}</b></td>
