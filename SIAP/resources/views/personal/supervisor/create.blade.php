...
{!!Form::open(array('url'=>'supervisor','method'=>'POST','autocomplete'=>'off', 'files'=>'true'))!!}
            {{Form::token()}}
...
<div class="row">
  <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
    ...
    <input name="_token" value="{{csrf_token()}}" type="hidden"></input>
        <a href="{{URL::action('SupervisorController@index')}}" class="btn btn-danger btn-lg col-md-offset-2"><i class="fa fa-times" aria-hidden="true"></i>   Cancelar</a>
