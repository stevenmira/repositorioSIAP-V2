  ...
  <div class="col-lg-12 col-md-12 col-sm-12"> 
    ...
    <div class="row">
      ...
      <div class="form-group col-md-4">
        ...
        {{ Form::select('idejecutivo', $ejecutivos->pluck('nombre','idejecutivo'), null, ['class'=>'form-control', 'placeholder'=>'-- Selecciona el Ejecutivo --']) }}
      </div>

      <div class="form-group col-md-4">
        <label for="cartera">Supervisor</label>
        {{ Form::select('idsupervisor', $supervisores->pluck('nombre','idsupervisor'), null, ['class'=>'form-control', 'placeholder'=>'-- Selecciona el Supervisor--']) }}
      </div>
    </div>
