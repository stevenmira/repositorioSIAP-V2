		...
		<table align="center" style="border-collapse: collapse; width: 99%;" >
			<thead>
				<tr>
					...
					<th style="border: 1px solid #333; width: 200px;" align="center"rowspan="2"><span style="font-size: 9px;">DESCRIPCIÓN</span></th>
			...
			<tbody>
				...
				<tr>
					...
					<td style="border: 1px solid #333" align="center"><span style="font-size: 10px;"> {{$estadoc->cuotadeuda}} CUOTAS DE ${{$prestamo->cuotadiaria}}. C/U</span></td>
				...
				<tr>
					...
					<td style="border: 1px solid #333" align="center"><span style="font-size: 10px;">{{$estadoc->diasexpirados}}</span></td>
