        ...
        <table style="">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: left; width: 20%;">{{$con->nombre}}</td>

                <td style="text-align: right; width: 18%;"><span class="pull-left">&nbsp;$</span>{{number_format($con->total0,2)}}</td>
                <?php $pt0 = $con->total0/$con->total2*100;?> 
                <td style="text-align: center; width: 7%">{{ round($pt0,2) }} %</td>

                <td style="text-align: right; width: 18%;"><span class="pull-left">&nbsp;$</span>{{number_format($con->total1,2)}}</td>
                <?php $pt1 = $con->total1/$con->total2*100;?>
                <td style="text-align: center; width: 7%;">{{ round($pt1,2) }} %</td>

                <td style="text-align: right; width: 18%;"><span class="pull-left">&nbsp;$</span>{{number_format($con->total2,2)}}</td>
                <?php $pt2 = $con->total2/$con->total2*100;?>
                <td style="text-align: center; width: 7%;">{{ round($pt2,2) }} %</td>
              </tr>
              @endforeach
            </tbody>
            <tr style="background:rgba(244, 67, 54, 0.1); font-size: 15px;">
                ...
                <td style="text-align: right;"><span class="pull-left">&nbsp;$</span>{{ number_format($suminteres,2) }}</td>
                <?php $pt0 = $suminteres/$sumtotaldiario*100;?>
                <td style="text-align: center; width: 5%;">{{ round($pt0,2) }} %</td>
                <td style="text-align: right;"><span class="pull-left">&nbsp;$</span>{{ number_format($sumcuotadiaria,2) }}</td>
                <?php $pt1 = $sumcuotadiaria/$sumtotaldiario*100;?>
                <td style="text-align: center; width: 5%;">{{ round($pt1,2) }} %</td>
                <td style="text-align: right;"><span class="pull-left">&nbsp;$</span>{{ number_format($sumtotaldiario,2) }}</td>
                <?php $pt2 = $sumtotaldiario/$sumtotaldiario*100;?>
                <td style="text-align: center; width: 5%;">{{ round($pt2,2) }} %</td>
            </tr>
        </table>
    </div>
</div>
...
<div class="row">
  <h3 style="text-align: center; padding: 30px 30px 30px 30px;">GRÁFICO DEL EFECTIVO RECIBIDO POR CARTERA EN PORCENTAJE (%)</h3>
    ...
    <div class="col-md-4">  
      <canvas id="{{$con->idcartera}}" width="800" height="450"></canvas>
      <script type="text/javascript">
        new Chart(document.getElementById("{{$con->idcartera}}"), 
        {
            type: 'pie',
            data: {
      ...
      <table style="border: 0px solid #fff;">
          <tr style="border: 0px solid #fff; border-color:#e8c3b9; border-style:dashed; border-width:2px;">
            ...
            <td style="border: 0px solid #fff; width: 35%; text-align: right; padding: 0px 30px;"><span class="pull-left">$</span> {{ number_format($con->total0,2) }}</td>
            <td style="border: 0px solid #fff; width: 25%;">{{$pt0}} %</td>
          </tr>
          <tr style="border: 0px solid #fff; border-color:#c45850; border-style:dashed; border-width:2px;">
            ...
            <td style="border: 0px solid #fff; width: 35%; text-align: right; padding: 0px 30px;"><span class="pull-left">$</span> {{ number_format($con->total1,2) }}</td>
            <td style="border: 0px solid #fff; width: 25%;">{{$pt1}} %</td>
          </tr>
          <tr style="border: 0px solid #fff; border-color:#fff; border-style:dashed; border-width:2px; font-weight: bold;">
            ...
            <td style="border: 0px solid #fff; width: 35%; text-align: right; padding: 0px 30px;"><span class="pull-left">$</span> {{ number_format($con->total2,2) }}</td>
            <td style="border: 0px solid #fff; width: 25%;">{{$pt2}} %</td>
          </tr>
        </table>
    </div>
    @endforeach
    ...
    <?php $ptt3 = round($sumtotaldiario/$sumtotaldiario*100,2);?>
      ...
      <table style="border: 0px solid #fff;">
          <tr style="border: 0px solid #fff; border-color:#3e95cd; border-style:dashed; border-width:2px;">
            ...
            <td style="border: 0px solid #fff; width: 35%; text-align: right; padding: 0px 30px;"><span class="pull-left">$</span> {{ number_format($suminteres,2) }}</td>
            <td style="border: 0px solid #fff; width: 25%;">{{$ptt1}} %</td>
          </tr>
          <tr style="border: 0px solid #fff; border-color:#8e5ea2; border-style:dashed; border-width:2px;">
            ...
            <td style="border: 0px solid #fff; width: 35%; text-align: right; padding: 0px 30px;"><span class="pull-left">$</span> {{ number_format($sumcuotadiaria,2) }}</td>
            <td style="border: 0px solid #fff; width: 25%;">{{$ptt2}} %</td>
          </tr>
          <tr style="border: 0px solid #fff; border-color:#fff; border-style:dashed; border-width:2px; font-weight: bold;">
            <td style="border: 0px solid #fff; width: 40%;">Total efectivo recibido</td>
            <td style="border: 0px solid #fff; width: 35%; text-align: right; padding: 0px 30px;"><span class="pull-left">$</span> {{ number_format($sumtotaldiario,2) }}</td>
            <td style="border: 0px solid #fff; width: 25%;">{{$ptt3}} %</td>
          </tr>
        </table>
    </div>
</div>
...
<br>
  ...
  <div>
    <a href="{{URL::action('ReportesController@grafico')}}" class="btn btn-primary btn-md col-md-offset-1"> REGRESAR</a>
  </div>
