...
<html>
<head>
	<title>Formato Desembolso Refinanciamiento</title>
	<style type="text/css">
		@page{
			margin-top: 10.0mm;
...
<body>
	...
	<div>
		<table align="center" style="width: 90%; border-collapse: collapse;">
			<tr>
				<th style="border: 1px solid #333" align="center" rowspan="2">N</th>
				<th style="border: 1px solid #333" align="center" rowspan="2">MONTO</th>
				<th style="border: 1px solid #333; height: 15px" align="center"> </th>
				<th style="border: 1px solid #333" align="center" rowspan="2"> </th>
			</tr>
			<tr>
				<td	style="border: 1px solid #333; height: 15px" align="center"> </td>
			</tr>
			<tr>
				<td style="border: 1px solid #333" align="right"></td>
